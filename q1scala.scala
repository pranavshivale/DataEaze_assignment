...
q1_op.show()
q1_op.write.format("csv").option("header", "true").save("s3://ngap2-user-data/dsmimengineeringnonprod/PSadan/op/q1")
...
q2_op.show()
q2_op.write.format("csv").option("header", "true").save("s3://ngap2-user-data/dsmimengineeringnonprod/PSadan/op/q2")
...
q3_op.show()
q3_op.write.format("csv").option("header", "true").save("s3://ngap2-user-data/dsmimengineeringnonprod/PSadan/op/q3")
...
q4_op.show()
q4_op.write.format("csv").option("header", "true").save("s3://ngap2-user-data/dsmimengineeringnonprod/PSadan/op/q4")
...
q5_op.show()
q5_op.write.format("csv").option("header", "true").save("s3://ngap2-user-data/dsmimengineeringnonprod/PSadan/op/q5")
...
q6_op.show()
q6_op.write.format("csv").option("header", "true").save("s3://ngap2-user-data/dsmimengineeringnonprod/PSadan/op/q6")
